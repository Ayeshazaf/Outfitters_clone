...
import h_img3 from "../assets/Hero1.webp";
...
export default function Menhome() {
  ...
  const mensImages = [m1, m2, m3, m4, m5, m6, m7, m9, m10, m11, m12];
  ...
  return (
    ...
    <section className="bg-white">
      <div className="max-w-3xl px-19 pb-16">
        {/* Heading */}
    ...
    <section className="bg-white">
      <div className="max-w-2xl  px-19 py-16">
        {/* Heading */}
      ...
      {/* Product Grid */}
        <div className="flex h-150 p-5 gap-3 w-full overflow-x-auto hide-scrollbar">
          {products.map((product, idx) => (
            <div key={`${product.id}-rail-${idx}`} className=" flex-col space-y-3">
              <img
                src={product.image}
                alt={product.name}
      ...
      <div className="w-full ">
        ...
        <div className="flex gap-2 min-w-[1500px] overflow-x-auto hide-scrollbar">
          ...
          <div className="h-100 min-w-85 border space-y-3">
            ...
            />
            <div className="flex space-x-2 justify-center">
              <img src={m2} alt="Preview" className="w-10 h-10 rounded-full border" />
              <img src={m3} alt="Preview" className="w-10 h-10 rounded-full border" />
            </div>
          </div>
          ...
          <div className="h-100 min-w-85 border space-y-3">
            ...
            />
            <div className="flex space-x-2 justify-center">
              <img src={m5} alt="Preview" className="w-10 h-10 rounded-full border" />
              <img src={m6} alt="Preview" className="w-10 h-10 rounded-full border" />
            </div>
          </div>
          ...
          <div className="h-100 min-w-85 border space-y-3">
            ...
            />
            <div className="flex space-x-2 justify-center">
              <img src={m9} alt="Preview" className="w-10 h-10 rounded-full border" />
              <img src={m10} alt="Preview" className="w-10 h-10 rounded-full border" />
            </div>
          </div>
          ...
          <div className="h-100 min-w-85 border space-y-3">
            ...
            />
            <div className="flex space-x-2 justify-center">
              <img src={m12} alt="Preview" className="w-10 h-10 rounded-full border" />
              <img src={m1} alt="Preview" className="w-10 h-10 rounded-full border" />
            </div>
          </div>
          ...
          <div className="h-100 min-w-85 border space-y-3">
            ...
            <div className="flex space-x-2 justify-center">
              <img src={m3} alt="Preview" className="w-10 h-10 rounded-full border" />
              <img src={m4} alt="Preview" className="w-10 h-10 rounded-full border" />
            </div>
          </div>
        </div>
      </div>
