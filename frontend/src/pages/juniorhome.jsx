...
import J1 from "../assets/Juniors/j1.jpg";
import J2 from "../assets/Juniors/j2.jpg";
import J3 from "../assets/Juniors/j3.jpg";
import J4 from "../assets/Juniors/j4.jpg";
import J5 from "../assets/Juniors/j5.jpg";
import J6 from "../assets/Juniors/j6.jpg";
import J7 from "../assets/Juniors/j7.jpg";
import J8 from "../assets/Juniors/j8.jpg";
import J9 from "../assets/Juniors/j9.jpg";
import J10 from "../assets/Juniors/j10.jpg";
import J12 from "../assets/Juniors/j12.jpg";
...
export default function Juniorhome() {
  ...
  return (
    ...
    <section className="bg-white">
      ...
      <div className="flex flex-col w-full h-260 px-5 gap-2">
          {/* <div className=" ">
          <img
              src={J7}
      ...
      <div className="w-full ">
        ...
        <div className="flex gap-2 min-w-[1500px] overflow-x-auto hide-scrollbar">
          ...
          <div className="h-100 min-w-85 border space-y-3">
            ...
            />
            <div className="flex space-x-2 justify-center">
              <img src={J5} alt="Preview" className="w-10 h-10 rounded-full border object-cover" />
              <img src={J6} alt="Preview" className="w-10 h-10 rounded-full border object-cover" />
            </div>
          </div>
          ...
          <div className="h-100 min-w-85 border space-y-3">
            ...
            />
            <div className="flex space-x-2 justify-center">
              <img src={J8} alt="Preview" className="w-10 h-10 rounded-full border object-cover" />
              <img src={J9} alt="Preview" className="w-10 h-10 rounded-full border object-cover" />
            </div>
          </div>
          ...
          <div className="h-100 min-w-85 border space-y-3">
            ...
            />
            <div className="flex space-x-2 justify-center">
              <img src={J12} alt="Preview" className="w-10 h-10 rounded-full border object-cover" />
              <img src={J1} alt="Preview" className="w-10 h-10 rounded-full border object-cover" />
            </div>
          </div>
          ...
          <div className="h-100 min-w-85 border space-y-3">
            ...
            />
            <div className="flex space-x-2 justify-center">
              <img src={J3} alt="Preview" className="w-10 h-10 rounded-full border object-cover" />
              <img src={J4} alt="Preview" className="w-10 h-10 rounded-full border object-cover" />
            </div>
          </div>
          ...
          <div className="h-100 min-w-85 border space-y-3">
            ...
            <div className="flex space-x-2 justify-center">
              <img src={J6} alt="Preview" className="w-10 h-10 rounded-full border object-cover" />
              <img src={J7} alt="Preview" className="w-10 h-10 rounded-full border object-cover" />
            </div>
          </div>
          ...
          <div className="h-100 min-w-85 border space-y-3">
            ...
            <div className="flex space-x-2 justify-center">
              <img src={J9} alt="Preview" className="w-10 h-10 rounded-full border object-cover" />
              <img src={J10} alt="Preview" className="w-10 h-10 rounded-full border object-cover" />
            </div>
          </div>
        </div>
      </div>
